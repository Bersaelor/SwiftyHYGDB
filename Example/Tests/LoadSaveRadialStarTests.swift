...
class LoadSaveRadialStarTests: XCTestCase {
    ...
    override func setUp() {
        ...
        originalStar3Ds = SwiftyHYGDB.loadCSVData(from: originalDBPath, precess: true)
    }
    ...
    func test_04_RadialStarCoding() {
        // FIXME
    }

    func test_04_Star3DCoding() {
        // FIXME
    }
